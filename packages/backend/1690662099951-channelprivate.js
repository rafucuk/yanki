...
module.exports = class Channelprivate1690662099951 {
    name = 'Channelprivate1690662099951'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "channel" ALTER COLUMN "isPrivate" SET NOT NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cacde791c1f058874ef777f808" ON "channel" ("isPrivate") `);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cacde791c1f058874ef777f808"`);
        ...
        await queryRunner.query(`ALTER TABLE "channel" ALTER COLUMN "isPrivate" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "antenna" ALTER COLUMN "lastUsedAt" SET DEFAULT '2023-07-16 09:24:06.149509+00'`);
